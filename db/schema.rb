...
ActiveRecord::Schema.define(version: 20150405160632) do
  ...
  create_table "company", primary_key: "cID", force: :cascade do |t|
    ...
    t.text   "Descriprion",     :limit=>16777215
  ...
  create_table "hw_iosignaldim", primary_key: "ID", force: :cascade do |t|
    ...
    t.integer "signID",  :limit=>4, :null=>false, :index=>{:name=>"signID", :with=>["num", "type", "Project"], :unique=>true, :using=>:btree}
  ...
  create_table "pds_documentation", primary_key: "DocID", force: :cascade do |t|
    ...
    t.date     "getting_date"
    t.text     "DocTitle",     :limit=>65535
    t.text     "DocTitle_EN",  :limit=>65535
  ...
  add_index "pds_dr", ["Project", "drNum"], :name=>"UniqueDrnum", :unique=>true, :using=>:btree
  ...
  create_table "pds_dr_binobj", primary_key: "objID", force: :cascade do |t|
    ...
    t.binary   "BinObj",  :limit=>16777215
  ...
  create_table "pds_malfunction", primary_key: "MalfID", force: :cascade do |t|
    ...
    t.text     "shortDesc",        :limit=>65535, :null=>false
    t.text     "shortDesc_EN",     :limit=>65535
    t.text     "cause",            :limit=>65535, :null=>false
    t.text     "cause_EN",         :limit=>65535
    t.text     "fullDesc",         :limit=>16777215, :null=>false
    t.text     "fullDesc_EN",      :limit=>16777215
    t.string   "type",             :limit=>3, :default=>""
    t.text     "if_delete",        :limit=>16777215
  ...
  create_table "pds_simplifications", primary_key: "SimplID", force: :cascade do |t|
    ...
    t.text     "Desc_EN",    :limit=>65535
    t.text     "support",    :limit=>65535, :null=>false
    t.text     "support_EN", :limit=>65535
  ...
  create_table "pds_sys_description", primary_key: "SysID", force: :cascade do |t|
    ...
    t.text    "Description_EN", :limit=>4294967295
    t.text    "shortDesc",      :limit=>65535
    t.text    "shortDesc_EN",   :limit=>65535
  end
  add_index "pds_sys_description", ["Project", "sys"], :name=>"Project_sys", :unique=>true, :using=>:btree
  ...
  add_index "pds_valves", ["ed_power", "ctrl_power", "anc_power"], :name=>"ed_power_2", :using=>:btree

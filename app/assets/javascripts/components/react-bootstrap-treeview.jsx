...
var TreeView = React.createClass({
  ...
  filterData: function(pattern) {
    ...
    var newData = data.map(function(elem){
      if( elem.text.toLowerCase().includes(pattern)){
        elem.visible = true;
      }else{
        elem.visible = false;
      }
  ...
  render: function() {
    ...
    return (
      <div id='treeview' className='treeview'>
        <TreeSearch changeInput={this.filterData} />
  ...
  render: function(){
    ...
    return (
      <div className="react-search">
        ...
        <div className='btn btn-default btn-xs'>Reset</div>
      </div>
    );
  }
});
...
//
//   React.render(
//     <TreeView data={menu_data} enableLinks={true}
//       highlightSelected = {true}/>,

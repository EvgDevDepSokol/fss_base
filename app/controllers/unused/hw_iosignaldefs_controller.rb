class HwIosignaldefsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @hw_iosignaldef.save
        format.html { redirect_to @hw_iosignaldef, notice: 'Hw iosignaldef was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @hw_iosignaldef.update(hw_iosignaldef_params)
        format.html { redirect_to @hw_iosignaldef, notice: 'Hw iosignaldef was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to hw_iosignaldefs_url, notice: 'Hw iosignaldef was successfully destroyed.' }
  ...
  private
    ...
    def hw_iosignaldef_params
      params.require(:hw_iosignaldef).permit(:ioname, :memtype, :rem)
    end
end
